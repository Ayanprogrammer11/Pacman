...
const draw = function() {
  // Draw the rectangle of canvas sized, to make it a parent of Maze
...
const drawWalls = function() {
  for(let i = 0; i < map.length; i++) {
    for(let j = 0; j < map[0].length; j++) {
      if(map[i][j] === 1) createRect(j * oneBlockSize, i * oneBlockSize, oneBlockSize, oneBlockSize, '#342DCA');
    }
  }
}